                ...
                <Col className="col-md-6 border border-md-1 m-3 m-md-4 p-3 p-md-4 rounded shadow">
                    <Form>
                        ...
                        <Row className='mb-3'>
                            ...
                            <Col className='mb-2'>
                                <a href='#' className='btn btn-block d-md-none btn-lg btn-link text-muted'>Забыл пароль</a>
                                <a href='#' className='btn d-none d-md-inline-block btn-lg btn-link text-muted'>Забыл пароль</a>
                            </Col>
                        </Row>
                    </Form>
                </Col>
